...
<!-- { "blockType": "permissions", "name": "reportroot_getteamsteamactivitycounts" } -->
[!INCLUDE [permissions-table](../includes/permissions/reportroot-getteamsteamactivitycounts-permissions.md)]
