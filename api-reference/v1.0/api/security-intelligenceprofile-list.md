...
<!-- { "blockType": "permissions", "name": "security_intelligenceprofile_list" } -->
[!INCLUDE [permissions-table](../includes/permissions/security-intelligenceprofile-list-permissions.md)]
