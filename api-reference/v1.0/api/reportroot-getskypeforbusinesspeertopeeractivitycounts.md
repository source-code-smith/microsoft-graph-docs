...
<!-- { "blockType": "permissions", "name": "reportroot_getskypeforbusinesspeertopeeractivitycounts" } -->
[!INCLUDE [permissions-table](../includes/permissions/reportroot-getskypeforbusinesspeertopeeractivitycounts-permissions.md)]
