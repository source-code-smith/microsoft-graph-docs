...
<!-- { "blockType": "permissions", "name": "externalconnectors_externalgroup_update" } -->
[!INCLUDE [permissions-table](../includes/permissions/externalconnectors-externalgroup-update-permissions.md)]
...
# [Python](#tab/python)
[!INCLUDE [sample-code](../includes/snippets/python/update-externalgroup-python-snippets.md)]
[!INCLUDE [sdk-documentation](../includes/snippets/snippets-sdk-documentation-link.md)]
