...
|[Get delta of messages across all chats for user](../api/chats-getallmessages-delta.md)  | [chat](chat.md) collection| Get incremental changes for all messages from all chats that a user is a participant in, including 1:1 chats, group chats, and meeting chats. |
|[Send message in channel](../api/chatmessage-post.md) | [chatMessage](chatmessage.md)| Create a new root message in a channel.|
