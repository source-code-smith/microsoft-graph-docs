...
> [!IMPORTANT]
> Microsoft Graph Data Connect integration with Privileged Access Management (PAM) has been deprecated. Explore our **[improved Microsoft Graph onboarding experience](./onboarding-experience-overview.md)**.
...
* An approval request expires in 24 hours unless a Microsoft 365 data access approver acts on the request. A new request is submitted once every 24 hours for approval. If you see your copy activity waiting for approval (in the Authorization Pending stage), then work with a Microsoft 365 data access approver to get your request approved.
